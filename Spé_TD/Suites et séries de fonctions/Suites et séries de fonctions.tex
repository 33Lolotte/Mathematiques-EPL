...
\begin{ex}[Moulin.14]{$\Delta$ Composition}
...
\begin{ex}[Moulin.15]{$\Delta$ Limite uniforme sur $\R$ d'une suite de polynômes}
...
\begin{ex}[Moulin.17]{Une intégrale}
...
\begin{ex}[Moulin.18]{$\Delta$ Lipschitzianité}
...
\begin{ex}[Moulin.19]{$\star$ $\star$ $\star$ Version faible du théorème d'Ascoli}
	\begin{enumerate}
...
\begin{ex}[Moulin.22]{$\star$ Lemme de Riemann-Lebesgue généralisé}
...
\begin{ex}[Moulin.23]{$\Delta\star$ Premier théorème de Dini}
...
\begin{ex}[Moulin.24]{$\star$ Deuxième théorème de Dini}
...
\begin{ex}[Moulin.25]{$\star$ Théorème de Dini pour les fonctions convexes}
...
\begin{ex}[Moulin.27]{Uniforme continuité}
...
\begin{ex}[Moulin.28]{Intégrale et limite nulle}
...
\begin{ex}[Moulin.42]{$\star$ Théorème de Borel}
...
\begin{ex}[Moulin.52]{$\star$ Théorème de Mertens}
...
\begin{ex}[Moulin.56]{Approximation $\mathcal{C}^\infty$}
	Soit $f:[0,1]\to\R$.
	\begin{enumerate}
...
\begin{ex}[Moulin.58]{Analogue au précédent}
