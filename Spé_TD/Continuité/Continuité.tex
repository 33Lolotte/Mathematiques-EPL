...
\begin{ex}[Moulin.23]{$\star\star$ Continuité du passage à l'inverse}
...
\begin{ex}[Moulin.24]{Fonction en escalier sur des fermés}
...
\begin{ex}[Moulin.25]{$\Delta$ La dérivation n'est pas continue sur $\mathcal{C}^\infty$}
...
\begin{ex}[Moulin.31]{Supplémentaires topologiques}
...
\begin{ex}[Moulin.38]{$\star$ Théorème de Hahn-Banach en dimension finie}
