...
\begin{ex}[Moulin.01]{Centre d'un groupe}
...
\begin{ex}[Moulin.03]{Groupes de $\mathcal{M}_n(\K)$}
...
\begin{ex}[Moulin.06]{Groupe des caractères}
...
\begin{ex}[Moulin.07]{Racines $n$-èmes de l'unité}
...
\begin{ex}[Moulin.08]{Automorphismes de $\Z/p\Z$}
	\begin{enumerate}
...
\begin{ex}[Moulin.09]{$\Delta$ Sous-groupes additifs de $\R$}
...
\begin{ex}[Moulin.10]{$\star$ Sous-groupes fermés de $\C\st$}
...
\begin{ex}[Moulin.11]{Vers les équations de Pell-Fermat}
...
\begin{ex}[Moulin.13]{Parties sans somme d'un groupe}
...
\begin{ex}[Moulin.14]{$\Delta\star$ Une mesure de non commutativité}
...
\begin{ex}[Moulin.15 / X]{$\Delta$ Nombre fini de sous-groupes}
...
\begin{ex}[Moulin.16]{Groupes diédraux}
...
\begin{ex}[Moulin.19]{Groupe dont tous les éléments sont d'ordre 2}
...
\begin{ex}[Moulin.21]{Groupes d'ordre 6}
...
\begin{ex}[Moulin.23]{$\Delta\star$ Lemme de Cauchy}
...
\begin{ex}[Moulin.24]{Conjugaison dans le groupe symétrique}
...
\begin{ex}[Moulin.25]{Racine carré d'un $n$-cycle}
...
\begin{ex}[Moulin.29]{Matrices de permutations}
...
\begin{ex}[Moulin.30]{Caractéristique d'un anneau}
	Soit $A$ un anneau.
	\begin{enumerate}
...
\begin{ex}[Moulin.40]{$\star$ Anneau noethérien}
...
\begin{ex}[Moulin.34]{Idéal engendré par les produits}
...
\begin{ex}[Moulin.35]{Une réciproque du théorème chinois}
...
\begin{ex}[Moulin.37]{Détermination de morphismes}
...
\begin{ex}[Moulin.38]{Nilpotence dans $\Z/n\Z$}
...
\begin{ex}[Moulin.39 / Morlot]{Anneau des entiers d'Eisenstein}
...
\begin{ex}[Moulin.45]{Éléments algébriques}
...
\begin{ex}[Moulin.46]{Formule d'Euler}
	Montrer la formule d'Euler : $$n=\sum_{d\mid n}\varphi(d)$$ où $\varphi$ est l'indicatrice d'Euler.
\end{ex}

\begin{ex}[Moulin.47]{Produits d'entiers successifs et carrés parfaits}
...
\begin{ex}[Moulin.48]{$\Delta$ Nombres premiers congrus à $-1$ modulo $4$}
	Démontrer qu'il existe une infinité de nombres premiers congrus à $-1$ modulo $4$.
\end{ex}

\begin{ex}[Moulin.49]{$\Delta$ Carrés dans $\F_p$}
...
\begin{ex}[Moulin.51]{Une divisibilité étrange}
...
\begin{ex}[Moulin.52]{Une factorisation de Sophie Germain}
...
\begin{ex}[Moulin.53]{Équation du second degré dans $\Z/143\Z$}
...
\begin{ex}[Moulin.54]{Non divisibilité}
...
\begin{ex}[Moulin.55]{$\Delta$ Théorème de Wilson}
...
\begin{ex}[Moulin.57]{$\Delta$ Fonction de Möbius}
...
\begin{ex}[Moulin.58 / Morlot]{$\star$}
...
\begin{ex}[Moulin.59]{$n$ ne divise pas $2^n-1$}
...
\begin{ex}[Moulin.60]{$\Delta$ Nombres de Mersenne}
	\begin{enumerate}
