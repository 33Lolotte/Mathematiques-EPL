...
\begin{ex}[Moulin.03]{Recherche de développement asymptotique}
...
\begin{ex}[Moulin.05]{Théorème de convergence encadrée}
...
\end{proof}
\begin{ex}[Moulin.10]{Géométrique !}
...
\end{proof}
\begin{ex}[Moulin.11]{$\Delta$ Sophomore's dream}
...
\begin{ex}[Moulin.17]{Théorème de convergence monotone}
...
\end{rmq}
\begin{ex}[Moulin.20]{$\Delta$ Prolongements $\mathcal{C}^\infty$}
	\begin{enumerate}
...
\begin{ex}[Moulin.27]{Intégrales de Fresnel}
...
\begin{ex}[Moulin.28]{$\star$ Fonctions d'Airy}
...
\begin{ex}[Moulin.31]{$\Delta$ Fonction $\Gamma$ de la variable complexe}
...
\begin{ex}[Moulin.32]{Prolongement de la fonction $\zeta$}
	\begin{enumerate}
...
\begin{ex}[Moulin.33]{Théorème de Fubini sur les rectangles}
...
\begin{ex}[Moulin.34]{Théorème de Fubini sur les produits d'intervalles}
...
\begin{ex}[Moulin.35]{$\Delta$ Méthode de Laplace}
...
\begin{ex}[Moulin.36]{Application 1}
...
\begin{ex}[Moulin.37]{$\star$ Application 2}
...
\begin{ex}[Moulin.38]{$\star$ Application 3}
...
\begin{ex}[Moulin.12]{Transformée de Laplace}
