...
\begin{ex}[Moulin.04]{$\Delta$ Norme de Frobenius}
...
\begin{ex}[Moulin.06]{$\Delta$ Normes $l^p$}
	\begin{enumerate}
...
\begin{ex}[Moulin.14]{Norme de variation totale}
...
\begin{ex}[Moulin.15]{Norme quotient}
...
\begin{ex}[Moulin.17]{Convexes denses de $\R^d$}
...
\begin{ex}[Moulin.20]{$\Delta\star$ Théorème de Gauss-Lucas} Montrer que si $P$ est un polynôme complexe non constant, alors les racines de $P'$ sont dans l'enveloppe convexe des racines de $P$.
\end{ex}
\begin{proof}
...
\begin{ex}[Moulin.21]{$\Delta$}
	Soit $H$ un hyperplan d'un espace vectoriel normé $E$. Montrer que $H$ est fermé dans $E$ ou dense dans $E$.
\end{ex}
\begin{proof}
	Utiliser l fait que l'adhérence d'un SEV est un SEV. Par croissance de l'adhérence, $\overline{H}$ est un SEV coincé entre $H$ et $E$, donc c'est soit $H$, soit $E$, donc $H$ est soit fermé dans $E$, soit dense dans $E$.
\end{proof}
...
\begin{ex}[Moulin.26]{Parties discrètes}
	\begin{enumerate}
...
\begin{ex}[Moulin.34]{$\Delta$ Sous-groupes de $(\R,+)$}
...
\begin{ex}[Moulin.37]{$\Delta$} 
	\begin{enumerate}
		...
		\item Donner un exemple de sous-espace vectoriel de $E$ no fermé pour cette norme.
...
\begin{ex}[Moulin.44]{Topologie des matrices nilpotentes}
