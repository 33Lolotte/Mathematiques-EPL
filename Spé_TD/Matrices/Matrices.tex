...
\begin{ex}[Moulin.03]{Matrices damiers}
	\begin{enumerate}
...
\begin{ex}[Moulin.04]{Matrices magiques}
...
\begin{ex}[Moulin.05]{Quaternions}
...
\begin{ex}[Moulin.06]{$\Delta$ Idéaux bilatères de $\mathcal{M}_n(\K)$}
...
\begin{ex}[Moulin.12]{$\Delta$ Matrice antédiagonale}
...
\begin{ex}[Moulin.13]{Matrice Attila}
	On note $J\in\mathcal{M}_n(\K)$ la matrice Attila dont tous les coefficients valent $1$.
	\begin{enumerate}
		\item Déterminer la sous-algèbre de $\mathcal{M}_n(\K)$ engendré par $J$.
...
\end{ex}
\begin{proof}
	Traduire les hypothèses en termes d'applications linéaires. En déduire que $\im(a)$ et $\ker(a)$ son supplémentaires, puis raisonner matriciellement.
\end{proof}

\section{Rang, équivalence}

\begin{ex}[Moulin.19]{$\circ$}
	\begin{enumerate}
...
\begin{ex}[Moulin.30]{$\star$ Une application combinatoire du rang}
	\begin{enumerate}
...
\begin{ex}[Moulin.34]{$\star$ Similitude et surcorps}
...
\begin{ex}[Moulin.38]{$\circ$}
	Soit $A\in\mathcal{M}_{n,p}(\K)$ et $B\in\mathcal{M}_{p,n}(\K)$. Montrer que $(AB)^k$ et $(BA)^k$ ont même trace ($k\in$ ?).
\end{ex}

\begin{ex}[Moulin.39]{$\Delta$ Représentation des formes linéaires sur $\mathcal{M}_n(\K)$}
...
\begin{ex}[Moulin.44]{$\star$ Matrices de trace nulle}
	\begin{enumerate}
...
\begin{ex}[Moulin.46]{Sommes de symétries dans $\mathcal{M}_n(\C)$}
	\begin{enumerate}
...
\begin{ex}[Moulin.49]{$\Delta$ Matrices à diagonale dominante}
...
\begin{ex}[Moulin.52]{}
	Résoudre : $$\forall i\in\llbracket0,n\rrbracket,\ \sum_{j=0}^{n-1}jîx_j=\lambda^i$$
\end{ex}

\section{Déterminants}

\begin{ex}[Moulin.53]{$\Delta$}
...
\begin{ex}[Moulin.56]{$\Delta$ Vers la densité des matrices inversibles}
...
\begin{ex}[Moulin.59]{Déterminant circulant}
...
\begin{ex}[Moulin.60]{Déterminant de Cauchy}
...
\begin{ex}[Moulin.68]{$\star$ Produit de Kronecker} Pour $A=(a_{i,j})\in\mathcal{M}_n(\K)$ et $B\in\mathcal{M}_m(\K)$, on note : $$A\otimes B=\begin{pmatrix}
		a_{1,1}B&a_{1,2}B&\cdots&a_{1,n}B\\
		a_{2,1}B&a_{2,2}B&\cdots&a_{2,n}B\\
		\vdots&\vdots&&\vdots\\
		a_{n,1}B&a_{n,2}B&\cdots&a_{n,n}B
...
\begin{ex}{Déterminant de Pascal}
...
\begin{ex}[Moulin.79]{$\Delta\star$ Comatrice du produit}
