...
\begin{thm}{Caractérisation des homothéties (HP)}%prop
...
\begin{thm}{Table de multiplication des $E_{i,j}$}%prop
...
\begin{thm}{Produit par blocs}%prop
...
\begin{thm}{Traduction matricielle de la stabilité}%prop
