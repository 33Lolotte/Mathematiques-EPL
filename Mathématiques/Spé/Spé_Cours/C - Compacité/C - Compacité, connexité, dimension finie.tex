...
\paragraph{Terminologie} On dit parfois qu'il s'agit de la compacité au sens de Bolzano-Weierstrass.
...
\paragraph{Attention} Les parties compactes d'un espace métrique sont donc fermées et bornées? Mais la réciproque est fausse en général, sauf pour les espaces vectoriels de dimension finie.
...
\paragraph{Attention} L'image réciproque d'un compact par une application continue peut très bien ne pas être compacte. Elle est tout au plus fermée. Produire un exemple.
...
\begin{thm}{Compact $\implies$ précompact}%lem
...
\begin{thm}{Lemme de recouvrement}%lem
...
\paragraph{Attention} L'image réciproque d'un connexe par arcs par une application continue peut très bien ne pas être connexe par arcs. Produire un exemple.
...
\paragraph{Attention} Il existe des connexes non connexes par arcs : voir l'exercice Moulin.Comp.39.
