...
\begin{itemize}
	...
	\item Comme le prouve le cas de la distance de $0$ à $\R_+\st$, il n'existe pas toujours d'élément $a\in A$ tel que $d(x,A)=d(x,a)$. Lorsqu'un tel élément existe, on dit que la distance de $x$ à $A$ est atteinte.
\end{itemize}
\end{attention}
