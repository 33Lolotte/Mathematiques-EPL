...
\begin{attention}
	Si le terme général ne décroît pas en module, la série peut très bien diverger. par exemple pour : $$u_{2n}=\frac{1}{2^n}\quad \text{et}\quad u_{2n+1}=-\frac{1}{2n+1}.$$
\end{attention}
...
\begin{itemize}
	...
	\item la suite est réelle et le termes de chaque tranche sont du même signe. %vérifier
\end{itemize}
