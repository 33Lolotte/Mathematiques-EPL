...
\begin{thm}{}
	...
	\begin{itemize}
		...
		\item Si $u_n=o(v_n)$, alors $S_n(u)=(S_n(v))$.
...
Pour étudier une série $\displaystyle\sum f(n)$ semi-convergente, on peut considérer une primitive $F$ de $f$ et montrer que la série de terme général $f(n)-(F(n+1)-F(n))$ converge (absolument). la série $\displaystyle\sum f(n)$ converger alors si, et seulement si, $F(n)$ admet une limite finie.
