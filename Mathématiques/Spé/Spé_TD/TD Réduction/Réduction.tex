...
\end{ex}
\begin{proof}
	Trigonaliser pour se faire une idée et développer le calcul du polynôme minimal. Quitte à se placer dans une clôture algébrique, on pourra le faire de toute façon... Et donc cela donne le bon résultat, même si on n'a pas le droit de le faire !
\end{proof}
...
\begin{proof}
	...
	\begin{enumerate}
		...
		\item D'après la question et les théorèmes de cours, on en déduit que $A$ est diagonalisable si, et seulement si, $\Tr(A)\ne0$.
