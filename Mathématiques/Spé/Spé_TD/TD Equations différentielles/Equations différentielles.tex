...
\begin{ex}[Moulin.ED.15]{}
	...
	\begin{enumerate}
		...
		\item Montrer que $f$ et $g$ sont continues sur $\R_+$ et en déduire la valeur de $\displaystyle\int_{0}^{+\infty}\frac{\sin t}{t}dt$.
	\end{enumerate}
\end{ex}
