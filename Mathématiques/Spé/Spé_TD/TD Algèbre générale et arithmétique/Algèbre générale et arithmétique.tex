...
\begin{ex}[Moulin.AG.08]{Automorphismes de $\Z/p\Z$}
	\begin{enumerate}
		...
		\item En admettant que $(\Z/q\Z)\st$ est cyclique pour $q$ premier, déterminer l'ensemble des morphismes de groupes de $\Z/p\Z$ dans $\text{Aut}(\Z/q\Z)$ pour $p$ et $q$ premiers.
	\end{enumerate}
\end{ex}
...
\begin{ex}[Moulin.AG.23]{$\Delta\star$ Lemme de Cauchy}
	...
	\begin{enumerate}
		\item Montrer que $(g_1,\ldots,g_p)\mapsto(g_2,\ldots,g_p,g_1)$ définit une permutation $\sigma$ de $A$.
...
\begin{ex}[Moulin.AG.24]{Conjugaison dans le groupe symétrique}
	...
	\begin{enumerate}
		...
		\item Application : en considérant les transpositions, déterminer tous les morphismes de groupe de $\mathcal{S}(\llbracket1,n\rrbracket)$ dans $\C\st$.
	\end{enumerate}
\end{ex}
