...
\begin{ex}[Moulin.FV.15]{Utilisation des fonctions de décollage en douceur}
	Soit $a<b$.
	\begin{enumerate}
...
\begin{ex}[Moulin.FV.20]{Construction d'une suite strictement croissante de zéros des dérivées successives}
