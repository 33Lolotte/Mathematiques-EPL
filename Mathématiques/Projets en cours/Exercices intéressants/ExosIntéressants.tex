...
\begin{ex}
	Soit $X$ une partie fermée non vide d'un espace vectoriel de dimension finie, $k\in[0,1[$ et $f:X\to X$ une application $k$-lipschitzienne. Montrer que $f$ possède un unique point fixe.
\end{ex}
